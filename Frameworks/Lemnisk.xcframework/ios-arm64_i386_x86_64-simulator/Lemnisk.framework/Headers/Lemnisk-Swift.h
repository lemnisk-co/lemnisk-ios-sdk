...
SWIFT_CLASS_NAMED("AFSessionDelegate")
@interface AFAFSessionDelegate : NSObject
/// Initializes the <code>AFSessionDelegate</code> instance.
///
/// returns:
/// The new <code>AFSessionDelegate</code> instance.
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// Returns a <code>Bool</code> indicating whether the <code>AFSessionDelegate</code> implements or inherits a method that can respond
...
@interface AFAFSessionDelegate (SWIFT_EXTENSION(Lemnisk)) <NSURLSessionDownloadDelegate>
...
@interface AFAFSessionDelegate (SWIFT_EXTENSION(Lemnisk)) <NSURLSessionStreamDelegate>
...
@interface AFAFSessionDelegate (SWIFT_EXTENSION(Lemnisk)) <NSURLSessionDataDelegate>
...
@interface AFAFSessionDelegate (SWIFT_EXTENSION(Lemnisk)) <NSURLSessionDelegate>
...
@interface AFAFSessionDelegate (SWIFT_EXTENSION(Lemnisk)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC7Lemnisk15EncryptionUtils")
...
- (void)configureWithWriteKey:(NSString * _Nonnull)writeKey serverUrl:(NSString * _Nonnull)serverUrl enableAnalytics:(BOOL)enableAnalytics launchOptions:(NSDictionary<UIApplicationLaunchOptionsKey, id> * _Nullable)launchOptions;
- (void)configureWithWriteKey:(NSString * _Nonnull)writeKey serverUrl:(NSString * _Nonnull)serverUrl enablePush:(BOOL)enablePush enableAnalytics:(BOOL)enableAnalytics launchOptions:(NSDictionary<UIApplicationLaunchOptionsKey, id> * _Nullable)launchOptions;
- (void)configureWithWriteKey:(NSString * _Nonnull)writeKey serverUrl:(NSString * _Nonnull)serverUrl enablePush:(BOOL)enablePush launchOptions:(NSDictionary<UIApplicationLaunchOptionsKey, id> * _Nullable)launchOptions;
...
- (void)trackAppCrashedEvent:(NSString * _Nullable)crashReport;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC7Lemnisk12TaskDelegate")
